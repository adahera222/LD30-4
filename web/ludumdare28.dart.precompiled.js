...
_Completer: {"": "Object;",
  get$complete: function(_receiver) {
    return new P.BoundClosure$i1(this, P._Completer.prototype.complete$1, _receiver, "complete$1");
  }
},
...
_StreamController: {"": "Object;",
  ...
  _ensureDoneFuture$0: function() {
    if (this._doneFuture == null) {
      ...
      if ((this._state & 2) !== 0)
        this._doneFuture._async$_complete$1(null);
    }
...
ImageElement: {"": "HtmlElement;complete=,src}", "%": "HTMLImageElement"},
...
_Random: {"": "Object;",
  nextInt$1: function(max) {
    if (max < 0)
      throw H.wrapException(P.ArgumentError$("negative max: " + max));
    if (max > 4294967295)
      max = 4294967295;
...
main: function() {
  ...
  $._ctx = J.get$context2D$x($._canvas);
  $._state = new E.GameState(null, $._ctx);
  $._state.changeScreen$1(new D.TitleScreen(null));
  $._keyboard = E.Keyboard$();
  t1 = W.AudioElement_AudioElement(null);
  t1.src = "sounds/clear.wav";
  $._sndClear = t1;
  t1 = W.AudioElement_AudioElement(null);
  t1.src = "music/easystages.wav";
  t1.loop = true;
  $._song1 = t1;
  t1 = W.ImageElement_ImageElement(null, null, null);
  J.set$src$x(t1, "images/4pt-star-block.png");
  $._fourPtStar = t1;
  t1 = W.ImageElement_ImageElement(null, null, null);
  J.set$src$x(t1, "images/circle-block.png");
  $._circle = t1;
  t1 = W.ImageElement_ImageElement(null, null, null);
  J.set$src$x(t1, "images/diamond-block.png");
  $._diamond = t1;
  t1 = W.ImageElement_ImageElement(null, null, null);
  J.set$src$x(t1, "images/star-block.png");
  $._star = t1;
  t1 = W.ImageElement_ImageElement(null, null, null);
  J.set$src$x(t1, "images/triangle-block.png");
  $._triangle = t1;
  t1 = W.ImageElement_ImageElement(null, null, null);
  J.set$src$x(t1, "images/cursor.png");
  $._imgCursor = t1;
  t1 = W.ImageElement_ImageElement(null, null, null);
  J.set$src$x(t1, "images/cursor_verticle.png");
  $._imgCursorVerticle = t1;
  t1 = W.ImageElement_ImageElement(null, null, null);
  J.set$src$x(t1, "images/smoke1.png");
  t2 = W.ImageElement_ImageElement(null, null, null);
  J.set$src$x(t2, "images/smoke2.png");
  t3 = W.ImageElement_ImageElement(null, null, null);
  J.set$src$x(t3, "images/smoke3.png");
  $._imgSmoke = [t1, t2, t3];
  $._timer = 16.666666666666668;
  C.Window_methods.get$animationFrame(window).then$1(D.run$closure);
},

run: function(delta) {
  D.update(P.DateTime$_now().millisecondsSinceEpoch);
  $._state.render$0();
  C.Window_methods.get$animationFrame(window).then$1(D.run$closure);
},
...
update: function(time) {
  if (time - $._prevTick > $._timer) {
    $._state.update$1(time);
    $._prevTick = P.DateTime$_now().millisecondsSinceEpoch;
  }
},

TitleScreen: {"": "GameScreen;_titleImage",
  dispose$0: function() {
    J.remove$0$ax(this._titleImage);
  },
  init$0: function() {
    this._titleImage = W.ImageElement_ImageElement(null, null, null);
    J.set$src$x(this._titleImage, "images/title.png");
  },
  render$1: function(ctx) {
    ctx.drawImage(this._titleImage, 100, 0);
  ...
  update$1: function(time) {
    var t1;
    if ($._keyboard._keys.containsKey$1(13) || $._keyboard._keys.containsKey$1(32)) {
      $._ctx.clearRect(0, 0, 800, 600);
      t1 = $._keyboard._keys;
      t1.clear$0(t1);
      $._state.changeScreen$1(new D.GamePlayScreen(null, null, null));
    }
  }
},

WinScreen: {"": "GameScreen;_background",
  dispose$0: function() {
    J.remove$0$ax(this._background);
  },
  init$0: function() {
    this._background = W.ImageElement_ImageElement(null, null, null);
    J.set$src$x(this._background, "images/winscreen.png");
  },
  render$1: function(ctx) {
...
GamePlayScreen: {"": "GameScreen;_background,_level,_cursor",
  dispose$0: function() {
    J.remove$0$ax(this._background);
  },
  init$0: function() {
    this._background = W.ImageElement_ImageElement(null, null, null);
    J.set$src$x(this._background, "images/gameplaybg.png");
    this.changeLevel$1(new D.Level1(null, null, null, null, null, null, null, null, null, null, null));
    this._cursor = D.Cursor$();
    $._song1.play();
  },
  render$1: function(ctx) {
    var i, t1, puzzle, j, t2, strComplete;
    ctx.drawImage(this._background, 0, 0);
    ...
    for (i = 1; i <= 8; ++i) {
      t1 = 66 * i;
      ctx.fillRect(103, t1 + 3, 594, 1);
      ctx.fillRect(t1 + 103, 3, 1, 594);
    }
    t1 = this._level;
    if (t1 == null)
      return;
    puzzle = t1.get$puzzle();
    for (i = 0; i < puzzle.length; ++i) {
      t1 = i * 66 + 3;
      j = 0;
      while (true) {
        if (i >= puzzle.length)
          throw H.ioore(puzzle, i);
        t2 = J.get$length$asx(puzzle[i]);
        if (typeof t2 !== "number")
          throw H.iae(t2);
        if (!(j < t2))
          break;
        if (i >= puzzle.length)
          throw H.ioore(puzzle, i);
        this.drawImage$4(this, ctx, j * 66 + 103, t1, J.$index$asx(puzzle[i], j));
        ++j;
      }
    }
    this._level.render$1(ctx);
    if (J.get$complete$x(this._level) === true) {
      ctx.font = "48pt Calibri";
      strComplete = J.$add$ns(J.get$title$x(this._level), " Completed!");
      ctx.fillStyle = "rgba(255, 255, 255, 255)";
      C.CanvasRenderingContext2D_methods.fillText$3(ctx, strComplete, 150, 200);
      ctx.fillStyle = "rgba(0, 0, 0, 255)";
      ctx.strokeText(strComplete, 150, 200);
      ctx.font = "32pt Calibri";
      ctx.fillStyle = "rgba(255, 255, 255, 255)";
      C.CanvasRenderingContext2D_methods.fillText$3(ctx, "Press 'enter' to move on.", 185, 270);
      ctx.fillStyle = "rgba(0, 0, 0, 255)";
      ctx.strokeText("Press 'enter' to move on.", 185, 270);
    } else if (this._level.get$failed() === true) {
      ctx.font = "48pt Calibri";
      strComplete = C.JSString_methods.$add("You failed ", J.get$title$x(this._level)) + "!";
      ctx.fillStyle = "rgba(255, 255, 255, 255)";
      C.CanvasRenderingContext2D_methods.fillText$3(ctx, strComplete, 150, 200);
      ctx.fillStyle = "rgba(0, 0, 0, 255)";
      ctx.strokeText(strComplete, 150, 200);
      ctx.fillStyle = "rgba(255, 255, 255, 255)";
      C.CanvasRenderingContext2D_methods.fillText$3(ctx, "Press 'r' to retry.", 170, 270);
      ctx.fillStyle = "rgba(0, 0, 0, 255)";
      ctx.strokeText("Press 'r' to retry.", 170, 270);
    }
    t1 = this._cursor;
    t2 = t1._flipped ? $._imgCursorVerticle : $._imgCursor;
    ctx.drawImage(t2, t1._x * 66 + 103, t1._y * 66 + 3);
  },
  drawImage$4: function(_, ctx, x, y, type) {
    var block;
    switch (type) {
      case 1:
        block = $._fourPtStar;
  ...
  update$1: function(time) {
    var t1, t2;
    this._level.update$1(time);
    if ($._keyboard._keys.containsKey$1(37) || $._keyboard._keys.containsKey$1(65)) {
      t1 = this._cursor;
      t2 = t1._x - 1;
      if (t2 >= 0)
        t1._x = t2;
    } else if ($._keyboard._keys.containsKey$1(39) || $._keyboard._keys.containsKey$1(68))
      this._cursor.moveRight$0();
    if ($._keyboard._keys.containsKey$1(38) || $._keyboard._keys.containsKey$1(87)) {
      t1 = this._cursor;
      t2 = t1._y - 1;
      if (t2 >= 0)
        t1._y = t2;
    } else if ($._keyboard._keys.containsKey$1(40) || $._keyboard._keys.containsKey$1(83))
      this._cursor.moveDown$0();
    if ($._keyboard._keys.containsKey$1(13)) {
      t1 = J.get$complete$x(this._level);
      t2 = this._level;
      if (t1 === true)
        t2.nextLevel$1(this);
      else
        t2.swap$1(this._cursor);
    }
    if ($._keyboard._keys.containsKey$1(32))
      this._cursor.flip$0();
    if ($._keyboard._keys.containsKey$1(82))
      this._level.init$0();
    t1 = $._keyboard._keys;
    t1.clear$0(t1);
  }
...
Level: {"": "Object;",
  init$0: function() {
    this._title = "";
    var t1 = P.List_List(null, D.Point);
    H.setRuntimeTypeInfo(t1, [D.Point]);
    this._burningBlocks = t1;
    t1 = P.List_List(null, D.Point);
    H.setRuntimeTypeInfo(t1, [D.Point]);
    this._bricksToRemove = t1;
    this._frameCount = 0;
    this._animation = -1;
    this._brickCount = 0;
    ...
    t1 = P.List_List(null, [J.JSArray, J.JSInt]);
    H.setRuntimeTypeInfo(t1, [[J.JSArray, J.JSInt]]);
    this._puzzle = t1;
  },
  render$1: function(ctx) {
    var t1, point, t2, t3, t4;
    if (this._animation !== -1 && this._burningBlocks.length > 0)
      for (t1 = this._burningBlocks, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
        point = t1._current;
        t2 = $._imgSmoke;
        t3 = this._animation;
        t2.length;
        ...
        if (typeof t2 !== "number")
          throw t2.$mul();
        ctx.drawImage(t3, t4 * 66 + 103, t2 * 66 + 3);
      }
  },
  update$1: function(time) {
    var t1, falling, i, j, t2, t3, t4, point;
    t1 = this._frameCount;
    if (typeof t1 !== "number")
      throw t1.$add();
    this._frameCount = t1 + 1;
    t1 = this._frameCount;
    if (typeof t1 !== "number")
      throw t1.$gt();
    if (t1 > 10) {
      ...
      if (t1 !== -1) {
        ...
        if (t1 >= 3) {
          this._animation = -1;
          J.set$length$asx(this._burningBlocks, 0);
          this._triggerCheck = true;
        } else
          this._animation = t1;
        return;
      }
      for (falling = false, i = 7; i >= 0; --i)
        for (t1 = i + 1, j = 0; j < 9; ++j) {
          t2 = this._puzzle;
          if (i >= t2.length)
            throw H.ioore(t2, i);
          if (!J.$eq(J.$index$asx(t2[i], j), 0)) {
            t2 = this._puzzle;
            if (t1 >= t2.length)
              throw H.ioore(t2, t1);
            t2 = J.$eq(J.$index$asx(t2[t1], j), 0);
          } else
            t2 = false;
          if (t2) {
            t2 = this._puzzle;
            ...
            if (i >= t3)
              throw H.ioore(t2, i);
            J.$indexSet$ax(t4, j, J.$index$asx(t2[i], j));
            t2 = this._puzzle;
            if (i >= t2.length)
              throw H.ioore(t2, i);
            J.$indexSet$ax(t2[i], j, 0);
            falling = true;
          }
        }
      if (falling)
      ...
      for (i = 8; i >= 0; --i)
        for (j = 0; j < 9; ++j)
          this.checkBrick$2(i, j);
      t1 = this._bricksToRemove;
      t2 = t1.length;
      if (t2 > 0) {
        for (t1 = new H.ListIterator(t1, t2, 0, null); t1.moveNext$0();) {
          point = t1._current;
          t2 = this._puzzle;
          t3 = J.getInterceptor$x(point);
          t4 = t3.get$x(point);
          if (t4 >>> 0 !== t4 || t4 >= t2.length)
            throw H.ioore(t2, t4);
          J.$indexSet$ax(t2[t4], t3.get$y(point), 0);
          this._burningBlocks.push(new D.Point(t3.get$x(point), t3.get$y(point)));
        }
        $._sndClear.play();
        this._frameCount = 0;
        this._animation = 0;
        J.set$length$asx(this._bricksToRemove, 0);
        return;
      }
      if (this._triggerCheck === true) {
        this._complete = this.checkComplete$0();
        this._failed = this._complete !== true;
      }
    }
  },
  checkBrick$2: function(x, y) {
    var t1, search;
    t1 = this._puzzle;
    if (x < 0 || x >= t1.length)
      throw H.ioore(t1, x);
    search = J.$index$asx(t1[x], y);
    if (J.$eq(search, 0))
      return;
    this._brickCount = 1;
    this.checkNextBrick$4(x - 1, y, 0, search);
    this.checkNextBrick$4(x + 1, y, 2, search);
    t1 = this._brickCount;
    if (typeof t1 !== "number")
      throw t1.$ge();
    if (t1 >= 3) {
      this._bricksToRemove.push(new D.Point(x, y));
      return;
    }
    this._brickCount = 1;
    this.checkNextBrick$4(x, y - 1, 1, search);
    this.checkNextBrick$4(x, y + 1, 3, search);
    t1 = this._brickCount;
    if (typeof t1 !== "number")
      throw t1.$ge();
    if (t1 >= 3)
  ...
  checkNextBrick$4: function(x, y, direction, search) {
    var t1;
    switch (direction) {
      case 0:
        if (x < 0)
    ...
    if (x < 0 || x >= t1.length)
      throw H.ioore(t1, x);
    if (J.$eq(J.$index$asx(t1[x], y), search)) {
      t1 = this._brickCount;
      if (typeof t1 !== "number")
        throw t1.$add();
      this._brickCount = t1 + 1;
      switch (direction) {
        case 0:
          this.checkNextBrick$4(x - 1, y, direction, search);
          break;
        case 1:
          this.checkNextBrick$4(x, y - 1, direction, search);
          break;
        case 2:
          this.checkNextBrick$4(x + 1, y, direction, search);
          break;
  ...
  checkComplete$0: function() {
    ...
    for (i = 0; i < 9; ++i)
      for (j = 0; j < 9; ++j) {
        ...
        if (i >= t1.length)
          throw H.ioore(t1, i);
        if (!J.$eq(J.$index$asx(t1[i], j), 0))
          return false;
      }
    return true;
  },
  setBlankPuzzle$0: function() {
    var t1, i, t2, j;
    t1 = P.List_List(null, [J.JSArray, J.JSInt]);
    H.setRuntimeTypeInfo(t1, [[J.JSArray, J.JSInt]]);
    this._puzzle = t1;
  ...
  swap$1: function(cursor) {
    var t1, t2, temp, t3, pt, t4, t5;
    t1 = this._movesRemaining;
    if (typeof t1 !== "number")
      throw t1.$le();
    if (t1 <= 0)
      return;
    ...
    if (t2 < 0 || t2 >= t1.length)
      throw H.ioore(t1, t2);
    temp = J.$index$asx(t1[t2], cursor._x);
    t1 = cursor._flipped;
    t2 = cursor._x;
    t3 = cursor._y;
    pt = t1 ? new D.Point(t2, t3 + 1) : new D.Point(t2 + 1, t3);
    if (J.$eq(temp, 0)) {
      t1 = this._puzzle;
      t2 = pt._y;
      if (t2 >>> 0 !== t2 || t2 >= t1.length)
        throw H.ioore(t1, t2);
      t2 = J.$eq(J.$index$asx(t1[t2], pt._x), 0);
      t1 = t2;
    } else
      t1 = false;
    if (t1)
    ...
    if (t5 >>> 0 !== t5 || t5 >= t3)
      throw H.ioore(t1, t5);
    J.$indexSet$ax(t2, t4, J.$index$asx(t1[t5], pt._x));
    t5 = this._puzzle;
    t1 = pt._y;
    if (t1 >>> 0 !== t1 || t1 >= t5.length)
      throw H.ioore(t5, t1);
    J.$indexSet$ax(t5[t1], pt._x, temp);
    this._triggerCheck = true;
    t1 = this._movesRemaining;
    if (typeof t1 !== "number")
      throw t1.$sub();
    this._movesRemaining = t1 - 1;
  }
},
...
Cursor: {"": "Object;_flipped,_x,_y",
  ...
  flip$0: function() {
    ...
    var t1 = this._flipped;
    if (t1 && this._y >= 8)
      this._y = this._y - 1;
    else if (!t1 && this._x >= 8)
      this._x = this._x - 1;
  },
  ...
  static: {
Cursor$: function() {
  var t1 = new D.Cursor(null, null, null);
  t1.Cursor$0();
  return t1;
}}
...
Level1: {"": "Level;_puzzle,_frameCount,_animation,_brickCount,_movesRemaining,_title,_complete,_failed,_triggerCheck,_burningBlocks,_bricksToRemove",
  init$0: function() {
    var type, t1;
    D.Level.prototype.init$0.call(this);
    this.setBlankPuzzle$0();
    this._title = "Level 1";
    type = $.get$_random().nextInt$1(6);
    if (type === 0)
      type = 1;
    if (type > 5)
      type = 5;
    ...
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    J.$indexSet$ax(t1[8], 2, type);
    t1 = this._puzzle;
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    J.$indexSet$ax(t1[8], 3, type);
    t1 = this._puzzle;
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    J.$indexSet$ax(t1[8], 5, type);
  },
  render$1: function(ctx) {
    D.Level.prototype.render$1.call(this, ctx);
    if (this._complete !== true && this._failed !== true) {
      ctx.font = "24pt Calibri";
      ctx.fillStyle = "rgba(255, 255, 255, 255)";
      C.CanvasRenderingContext2D_methods.fillText$3(ctx, "Move with arrow keys or 'WADS'.", 180, 40);
      ctx.fillStyle = "rgba(0, 0, 0, 255)";
      ctx.strokeText("Move with arrow keys or 'WADS'.", 180, 40);
      ctx.fillStyle = "rgba(255, 255, 255, 255)";
      C.CanvasRenderingContext2D_methods.fillText$3(ctx, "Swap bricks with 'enter'.", 245, 80);
      ctx.fillStyle = "rgba(0, 0, 0, 255)";
      ctx.strokeText("Swap bricks with 'enter'.", 245, 80);
    }
  },
  nextLevel$1: function($screen) {
    $screen.changeLevel$1(new D.Level2(null, null, null, null, null, null, null, null, null, null, null));
  }
},

Level2: {"": "Level;_puzzle,_frameCount,_animation,_brickCount,_movesRemaining,_title,_complete,_failed,_triggerCheck,_burningBlocks,_bricksToRemove",
  init$0: function() {
    var type, t1;
    D.Level.prototype.init$0.call(this);
    this.setBlankPuzzle$0();
  ...
  render$1: function(ctx) {
    ...
    if (this._complete !== true && this._failed !== true) {
      ctx.font = "24pt Calibri";
      ctx.fillStyle = "rgba(255, 255, 255, 255)";
      C.CanvasRenderingContext2D_methods.fillText$3(ctx, "Bricks are able to fall.", 265, 40);
      ctx.fillStyle = "rgba(0, 0, 0, 255)";
      ctx.strokeText("Bricks are able to fall.", 265, 40);
    }
  },
  nextLevel$1: function($screen) {
    $screen.changeLevel$1(new D.Level3(null, null, null, null, null, null, null, null, null, null, null));
  }
},

Level3: {"": "Level;_puzzle,_frameCount,_animation,_brickCount,_movesRemaining,_title,_complete,_failed,_triggerCheck,_burningBlocks,_bricksToRemove",
  init$0: function() {
    D.Level.prototype.init$0.call(this);
    this.setBlankPuzzle$0();
    this._title = "Level 3";
    ...
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    J.$indexSet$ax(t1[8], 2, 5);
    t1 = this._puzzle;
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    J.$indexSet$ax(t1[8], 3, 5);
    t1 = this._puzzle;
    if (7 >= t1.length)
      throw H.ioore(t1, 7);
    J.$indexSet$ax(t1[7], 4, 5);
    t1 = this._puzzle;
    if (7 >= t1.length)
      throw H.ioore(t1, 7);
    J.$indexSet$ax(t1[7], 2, 4);
    t1 = this._puzzle;
    if (7 >= t1.length)
      throw H.ioore(t1, 7);
    J.$indexSet$ax(t1[7], 3, 4);
    t1 = this._puzzle;
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    J.$indexSet$ax(t1[8], 4, 4);
  },
  render$1: function(ctx) {
    D.Level.prototype.render$1.call(this, ctx);
    if (this._complete !== true && this._failed !== true) {
      ctx.font = "24pt Calibri";
      ctx.fillStyle = "rgba(255, 255, 255, 255)";
      C.CanvasRenderingContext2D_methods.fillText$3(ctx, "Press 'space' to rotate.", 255, 40);
      ctx.fillStyle = "rgba(0, 0, 0, 255)";
      ctx.strokeText("Press 'space' to rotate.", 255, 40);
    }
  },
  nextLevel$1: function($screen) {
    $screen.changeLevel$1(new D.Level4(null, null, null, null, null, null, null, null, null, null, null));
  }
},

Level4: {"": "Level;_puzzle,_frameCount,_animation,_brickCount,_movesRemaining,_title,_complete,_failed,_triggerCheck,_burningBlocks,_bricksToRemove",
  init$0: function() {
    D.Level.prototype.init$0.call(this);
    this.setBlankPuzzle$0();
    this._title = "Level 4";
    ...
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    J.$indexSet$ax(t1[8], 4, 5);
    t1 = this._puzzle;
    if (6 >= t1.length)
      throw H.ioore(t1, 6);
    J.$indexSet$ax(t1[6], 3, 4);
    t1 = this._puzzle;
    if (7 >= t1.length)
      throw H.ioore(t1, 7);
    J.$indexSet$ax(t1[7], 4, 4);
    t1 = this._puzzle;
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    J.$indexSet$ax(t1[8], 5, 4);
  },
  render$1: function(ctx) {
    D.Level.prototype.render$1.call(this, ctx);
    if (this._complete !== true && this._failed !== true) {
      ctx.font = "24pt Calibri";
      ctx.fillStyle = "rgba(255, 255, 255, 255)";
      C.CanvasRenderingContext2D_methods.fillText$3(ctx, "Bricks chain clear as they fall.", 205, 40);
      ctx.fillStyle = "rgba(0, 0, 0, 255)";
      ctx.strokeText("Bricks chain clear as they fall.", 205, 40);
    }
  },
  nextLevel$1: function($screen) {
    $screen.changeLevel$1(new D.Level5(null, null, null, null, null, null, null, null, null, null, null));
  }
},

Level5: {"": "Level;_puzzle,_frameCount,_animation,_brickCount,_movesRemaining,_title,_complete,_failed,_triggerCheck,_burningBlocks,_bricksToRemove",
  init$0: function() {
    D.Level.prototype.init$0.call(this);
    this.setBlankPuzzle$0();
    this._title = "Level 5";
    ...
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    t1[8] = [0, 1, 1, 2, 2, 3, 2, 2, 0];
    t1[7] = [0, 1, 2, 3, 3, 4, 4, 0, 0];
    J.$indexSet$ax(t1[6], 4, 4);
    t1 = this._puzzle;
    if (6 >= t1.length)
      throw H.ioore(t1, 6);
    J.$indexSet$ax(t1[6], 5, 2);
  },
  render$1: function(ctx) {
    D.Level.prototype.render$1.call(this, ctx);
  },
  nextLevel$1: function($screen) {
    $screen.changeLevel$1(new D.Level6(null, null, null, null, null, null, null, null, null, null, null));
  }
},

Level6: {"": "Level;_puzzle,_frameCount,_animation,_brickCount,_movesRemaining,_title,_complete,_failed,_triggerCheck,_burningBlocks,_bricksToRemove",
  init$0: function() {
    D.Level.prototype.init$0.call(this);
    this.setBlankPuzzle$0();
    this._title = "Level 6";
    ...
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    t1[8] = [0, 1, 2, 1, 1, 4, 0, 0, 0];
    t1[7] = [0, 2, 2, 4, 4, 0, 0, 0, 0];
    t1[6] = [0, 0, 3, 2, 2, 0, 0, 0, 0];
    J.$indexSet$ax(t1[5], 2, 2);
    t1 = this._puzzle;
    if (5 >= t1.length)
      throw H.ioore(t1, 5);
    J.$indexSet$ax(t1[5], 3, 2);
    t1 = this._puzzle;
    if (4 >= t1.length)
      throw H.ioore(t1, 4);
    J.$indexSet$ax(t1[4], 2, 3);
    t1 = this._puzzle;
    if (3 >= t1.length)
      throw H.ioore(t1, 3);
    J.$indexSet$ax(t1[3], 2, 3);
    t1 = this._puzzle;
    if (2 >= t1.length)
      throw H.ioore(t1, 2);
    J.$indexSet$ax(t1[2], 2, 1);
    t1 = this._puzzle;
    if (1 >= t1.length)
      throw H.ioore(t1, 1);
    J.$indexSet$ax(t1[1], 2, 2);
  },
  render$1: function(ctx) {
    D.Level.prototype.render$1.call(this, ctx);
  },
  nextLevel$1: function($screen) {
    $screen.changeLevel$1(new D.Level7(null, null, null, null, null, null, null, null, null, null, null));
  }
},

Level7: {"": "Level;_puzzle,_frameCount,_animation,_brickCount,_movesRemaining,_title,_complete,_failed,_triggerCheck,_burningBlocks,_bricksToRemove",
  init$0: function() {
    D.Level.prototype.init$0.call(this);
    this.setBlankPuzzle$0();
    this._title = "Level 7";
    ...
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    t1[8] = [0, 0, 2, 2, 1, 3, 3, 4, 4];
    t1[7] = [0, 0, 0, 2, 2, 1, 3, 3, 0];
    t1[6] = [0, 0, 0, 0, 1, 2, 1, 1, 0];
    t1[5] = [0, 0, 0, 0, 1, 0, 4, 3, 0];
    J.$indexSet$ax(t1[4], 4, 3);
    t1 = this._puzzle;
    if (3 >= t1.length)
      throw H.ioore(t1, 3);
    J.$indexSet$ax(t1[3], 4, 2);
  },
  render$1: function(ctx) {
    D.Level.prototype.render$1.call(this, ctx);
  },
  nextLevel$1: function($screen) {
    $screen.changeLevel$1(new D.Level8(null, null, null, null, null, null, null, null, null, null, null));
  }
},

Level8: {"": "Level;_puzzle,_frameCount,_animation,_brickCount,_movesRemaining,_title,_complete,_failed,_triggerCheck,_burningBlocks,_bricksToRemove",
  init$0: function() {
    D.Level.prototype.init$0.call(this);
    this.setBlankPuzzle$0();
    this._title = "Level 8";
    ...
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    t1[8] = [0, 3, 3, 2, 3, 3, 2, 2, 0];
    t1[7] = [0, 4, 4, 3, 2, 2, 3, 3, 0];
    t1[6] = [0, 2, 2, 4, 1, 5, 5, 2, 0];
    t1[5] = [0, 3, 3, 2, 5, 2, 2, 4, 0];
    t1[4] = [0, 4, 4, 3, 3, 4, 4, 2, 0];
    J.$indexSet$ax(t1[2], 3, 1);
    t1 = this._puzzle;
    if (3 >= t1.length)
      throw H.ioore(t1, 3);
    J.$indexSet$ax(t1[3], 2, 1);
    t1 = this._puzzle;
    if (3 >= t1.length)
      throw H.ioore(t1, 3);
    J.$indexSet$ax(t1[3], 3, 4);
    t1 = this._puzzle;
    if (3 >= t1.length)
      throw H.ioore(t1, 3);
    J.$indexSet$ax(t1[3], 5, 3);
    t1 = this._puzzle;
    if (3 >= t1.length)
      throw H.ioore(t1, 3);
    J.$indexSet$ax(t1[3], 6, 3);
  },
  render$1: function(ctx) {
    D.Level.prototype.render$1.call(this, ctx);
  },
  nextLevel$1: function($screen) {
    $screen.changeLevel$1(new D.Level9(null, null, null, null, null, null, null, null, null, null, null));
  }
},

Level9: {"": "Level;_puzzle,_frameCount,_animation,_brickCount,_movesRemaining,_title,_complete,_failed,_triggerCheck,_burningBlocks,_bricksToRemove",
  init$0: function() {
    D.Level.prototype.init$0.call(this);
    this.setBlankPuzzle$0();
    this._title = "Level 9";
    ...
    if (8 >= t1.length)
      throw H.ioore(t1, 8);
    t1[8] = [5, 1, 1, 2, 1, 1, 5, 1, 4];
    t1[7] = [2, 3, 4, 2, 4, 4, 5, 1, 4];
    t1[6] = [5, 2, 3, 1, 1, 3, 1, 3, 3];
    t1[5] = [5, 0, 2, 2, 0, 0, 5, 1, 4];
    J.$indexSet$ax(t1[4], 0, 3);
    t1 = this._puzzle;
    if (4 >= t1.length)
      throw H.ioore(t1, 4);
    J.$indexSet$ax(t1[4], 3, 1);
    t1 = this._puzzle;
    if (3 >= t1.length)
      throw H.ioore(t1, 3);
    J.$indexSet$ax(t1[3], 3, 4);
  ...
  nextLevel$1: function($screen) {
    $._state.changeScreen$1(new D.WinScreen(null));
  }
}},
1],
["urlsGameLib", "urlsGameLib.dart", , E, {
GameState: {"": "Object;_screen,_ctx",
  changeScreen$1: function($screen) {
    var t1 = this._screen;
    if (t1 != null)
      t1.dispose$0();
    this._screen = $screen;
...
Keyboard: {"": "Object;_keys",
  Keyboard$0: function() {
    ...
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new E.Keyboard_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = new W._EventStream(window, C.EventStreamProvider_keyup._eventType, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t1 = new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new E.Keyboard_closure0(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
  },
  static: {
Keyboard$: function() {
  var t1 = new E.Keyboard(P.HashMap_HashMap(null, null, null, J.JSInt, J.JSInt));
  t1.Keyboard$0();
  return t1;
}}
...
init.globalFunctions.run$closure = D.run$closure = new P.Closure$1(D.run, "run$closure");
...
function dart_precompiled($collectedClasses) {
  ...
  function TitleScreen(_titleImage) {
    this._titleImage = _titleImage;
  }
  TitleScreen.builtin$cls = "TitleScreen";
  if (!"name" in TitleScreen)
    TitleScreen.name = "TitleScreen";
  $desc = $collectedClasses.TitleScreen;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TitleScreen.prototype = $desc;
  function WinScreen(_background) {
    this._background = _background;
  }
  WinScreen.builtin$cls = "WinScreen";
  if (!"name" in WinScreen)
    WinScreen.name = "WinScreen";
  $desc = $collectedClasses.WinScreen;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WinScreen.prototype = $desc;
  function GamePlayScreen(_background, _level, _cursor) {
    this._background = _background;
    this._level = _level;
    this._cursor = _cursor;
  }
  GamePlayScreen.builtin$cls = "GamePlayScreen";
  if (!"name" in GamePlayScreen)
    GamePlayScreen.name = "GamePlayScreen";
  $desc = $collectedClasses.GamePlayScreen;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GamePlayScreen.prototype = $desc;
  function Level() {
  }
  ...
  function Cursor(_flipped, _x, _y) {
  ...
  function Level1(_puzzle, _frameCount, _animation, _brickCount, _movesRemaining, _title, _complete, _failed, _triggerCheck, _burningBlocks, _bricksToRemove) {
    this._puzzle = _puzzle;
    this._frameCount = _frameCount;
    this._animation = _animation;
    this._brickCount = _brickCount;
    this._movesRemaining = _movesRemaining;
    this._title = _title;
    this._complete = _complete;
    this._failed = _failed;
    this._triggerCheck = _triggerCheck;
    this._burningBlocks = _burningBlocks;
    this._bricksToRemove = _bricksToRemove;
  }
  ...
  function Level2(_puzzle, _frameCount, _animation, _brickCount, _movesRemaining, _title, _complete, _failed, _triggerCheck, _burningBlocks, _bricksToRemove) {
    this._puzzle = _puzzle;
    this._frameCount = _frameCount;
    this._animation = _animation;
    this._brickCount = _brickCount;
  ...
  function Level3(_puzzle, _frameCount, _animation, _brickCount, _movesRemaining, _title, _complete, _failed, _triggerCheck, _burningBlocks, _bricksToRemove) {
    this._puzzle = _puzzle;
    this._frameCount = _frameCount;
    this._animation = _animation;
    this._brickCount = _brickCount;
  ...
  function Level4(_puzzle, _frameCount, _animation, _brickCount, _movesRemaining, _title, _complete, _failed, _triggerCheck, _burningBlocks, _bricksToRemove) {
    this._puzzle = _puzzle;
    this._frameCount = _frameCount;
    this._animation = _animation;
    this._brickCount = _brickCount;
  ...
  function Level5(_puzzle, _frameCount, _animation, _brickCount, _movesRemaining, _title, _complete, _failed, _triggerCheck, _burningBlocks, _bricksToRemove) {
    this._puzzle = _puzzle;
    this._frameCount = _frameCount;
    this._animation = _animation;
    this._brickCount = _brickCount;
  ...
  function Level6(_puzzle, _frameCount, _animation, _brickCount, _movesRemaining, _title, _complete, _failed, _triggerCheck, _burningBlocks, _bricksToRemove) {
    this._puzzle = _puzzle;
    this._frameCount = _frameCount;
    this._animation = _animation;
    this._brickCount = _brickCount;
  ...
  function Level7(_puzzle, _frameCount, _animation, _brickCount, _movesRemaining, _title, _complete, _failed, _triggerCheck, _burningBlocks, _bricksToRemove) {
    this._puzzle = _puzzle;
    this._frameCount = _frameCount;
    this._animation = _animation;
    this._brickCount = _brickCount;
  ...
  Level7.builtin$cls = "Level7";
  if (!"name" in Level7)
    Level7.name = "Level7";
  $desc = $collectedClasses.Level7;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Level7.prototype = $desc;
  function Level8(_puzzle, _frameCount, _animation, _brickCount, _movesRemaining, _title, _complete, _failed, _triggerCheck, _burningBlocks, _bricksToRemove) {
    this._puzzle = _puzzle;
    this._frameCount = _frameCount;
    this._animation = _animation;
    this._brickCount = _brickCount;
  ...
  Level8.builtin$cls = "Level8";
  if (!"name" in Level8)
    Level8.name = "Level8";
  $desc = $collectedClasses.Level8;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Level8.prototype = $desc;
  function Level9(_puzzle, _frameCount, _animation, _brickCount, _movesRemaining, _title, _complete, _failed, _triggerCheck, _burningBlocks, _bricksToRemove) {
    this._puzzle = _puzzle;
    this._frameCount = _frameCount;
    this._animation = _animation;
    this._brickCount = _brickCount;
  ...
  Level9.builtin$cls = "Level9";
  if (!"name" in Level9)
    Level9.name = "Level9";
  $desc = $collectedClasses.Level9;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Level9.prototype = $desc;
  function GameState(_screen, _ctx) {
